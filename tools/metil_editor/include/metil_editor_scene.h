...
#define metil_editor_scene_length_renderables 0x07
...
enum metil_editor_scene_index_renderable {
  ...
  metil_editor_scene_index_renderable_group_text_position_cursor = 0x04,
  metil_editor_scene_index_renderable_group_text_position_vertex = 0x05,
  metil_editor_scene_index_renderable_group_text_length_vertices = 0x06
};
