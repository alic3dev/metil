...
[[vertex]] struct data_vertex_basic_point_coloured metil_editor_cursor_vertex(
...
[[fragment]] float4 metil_editor_cursor_fragment(
  struct data_vertex_basic_point_coloured data_vertex_basic_coloured [[stage_in]]
) {
