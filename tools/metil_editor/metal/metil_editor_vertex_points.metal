...
[[vertex]] struct data_vertex_basic_point_coloured metil_editor_vertex_points_vertex(
  ...
  struct data_vertex_basic_point_coloured data_vertex_basic_point_coloured;

  data_vertex_basic_point_coloured.position = (
  ...
  return (
    data_vertex_basic_point_coloured
  );
}

[[fragment]] float4 metil_editor_vertex_points_fragment(
  struct data_vertex_basic_point_coloured data_vertex_basic_coloured [[
    stage_in
  ]]
) {
