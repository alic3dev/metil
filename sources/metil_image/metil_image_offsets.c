...
const struct metil_image_offsets metil_image_offsets_rgba_8 = {
  .bytes = (
    metil_image_offset_rgba_8_bytes
  ),
  .r = (
...
const struct metil_image_offsets metil_image_offsets_bgra_8 = {
  .bytes = (
    metil_image_offset_bgra_8_bytes
  ),
  .r = (
    metil_image_offset_bgra_8_r
  ),
  .g = (
    metil_image_offset_bgra_8_g
  ),
  .b = (
    metil_image_offset_bgra_8_b
  ),
  .a = (
    metil_image_offset_bgra_8_a
  )
};

const struct metil_image_offsets metil_image_offsets_unknown = {
  .bytes = (
    metil_image_offset_unknown_bytes
  ),
  .r = (
    metil_image_offset_unknown_r
  ),
  .g = (
    metil_image_offset_unknown_g
  ),
  .b = (
    metil_image_offset_unknown_b
  ),
  .a = (
    metil_image_offset_unknown_a
  )
};
