#include <rendering/metil_renderer.h>
...
- (nonnull instancetype) initWithMetalKitView: (nonnull MTKView*) metal_kit_view {
  ...
  id<MTLFunction> function_vertex = [library_default newFunctionWithName: @"metil_shader_vertex"];
  id<MTLFunction> function_fragment = [library_default newFunctionWithName: @"metil_shader_fragment"];
  ...
  scene_controller_on_scene_change_add(
    metil_renderer_on_scene_change,
    self
  );
